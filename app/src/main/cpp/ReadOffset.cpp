...
jobjectArray Decompress(JNIEnv* env,jstring jstr){
    jclass jniclass = (*env).FindClass("org.woheller69.weather/CacheScan");
    if (NULL == jniclass) {
...
//    std::string test_oat = "/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/org.woheller69.weather-2MHAAyKgevL7Ukh95mm_XA==/oat/arm64/base.odex";
//    read_file = test_oat;
...
//    jstring jstr = env->NewStringUTF("/data/app/~~BB-vA7qXu3RTmOnbg9z9hg==/org.woheller69.weather-2MHAAyKgevL7Ukh95mm_XA==/base.apk");//turn to jstring
