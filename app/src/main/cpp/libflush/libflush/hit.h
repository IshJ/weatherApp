...
int hit7(jlong *param, int length, int threshold, long *timingCount, long *times, int *logs, long *timingCounts, long *addresses, int *log_length, pthread_mutex_t *g_lock);
...
int adjust_threshold(int threshold, int* length_of_camera_audio, size_t* addr, int* camera_audio, int* finishtrial1);
