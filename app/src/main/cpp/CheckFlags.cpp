...
such as Java_org_woheller69_weather_CacheScan_GetPattern to get the activated pattern etc.
*/
...
Java_org_woheller69_weather_CacheScan_CacheCheck(JNIEnv *env, jobject thiz) {
    jintArray ja = env->NewIntArray(compiler_position);
    jint *arr = env->GetIntArrayElements(ja, NULL);
    if (flags != NULL) {
        pthread_mutex_lock(&g_lock);
        memcpy(arr, flags,
               sizeof(int) * (compiler_position - 1));//no need to retrieve the compiler activation
...
extern "C" JNIEXPORT jintArray JNICALL
Java_org_woheller69_weather_CacheScan_GetT(JNIEnv *env, jobject thiz) {
...
extern "C" JNIEXPORT jintArray JNICALL
Java_org_woheller69_weather_CacheScan_GetPattern(JNIEnv *env, jobject thiz, jint c) {
...
Java_org_woheller69_weather_CacheScan_ClearPattern(JNIEnv *env, jobject thiz, jint c) {
    pthread_mutex_lock(&g_lock);
    if (c == 1)
...
extern "C" JNIEXPORT jintArray JNICALL
Java_org_woheller69_weather_CacheScan_addr(JNIEnv *env, jobject thiz) {
    jintArray ja = env->NewIntArray(compiler_position);
    jint *arr = env->GetIntArrayElements(ja, NULL);
    if (addr != NULL) {
...
extern "C" JNIEXPORT jintArray JNICALL
Java_org_woheller69_weather_CacheScan_GetThresholds(JNIEnv *env, jobject thiz) {
    if (length != 0) {
        jintArray ja = env->NewIntArray(length);
        jint *arr = env->GetIntArrayElements(ja, NULL);
...
//Java_org_woheller69_weather_CacheScan_GetTimingCount(JNIEnv *env, jobject thiz) {
//    LOGD("sidescandb groundtruth cpp %ld ", timingCount);
//    return timingCount;
//}
...
/*
extern "C" JNIEXPORT jintArray JNICALL
Java_org_woheller69_weather_CacheScan_thd(JNIEnv *env, jobject thiz){
...
*/
extern "C" JNIEXPORT void JNICALL
Java_org_woheller69_weather_CacheScan_HandleCapture(JNIEnv *env, jobject thiz, jint i) {
    pthread_mutex_lock(&g_lock);
    flags[i] = 0;
    pthread_mutex_unlock(&g_lock);
}
...
extern "C" JNIEXPORT void JNICALL
Java_org_woheller69_weather_CacheScan_increase(JNIEnv *env, jobject thiz) {
    threshold += 5;
}

extern "C" JNIEXPORT void JNICALL
Java_org_woheller69_weather_CacheScan_decrease(JNIEnv *env, jobject thiz) {
    threshold -= 5;
}

extern "C" JNIEXPORT void JNICALL
Java_org_woheller69_weather_CacheScan_setthreshold(JNIEnv *env, jobject thiz, jint new_thresh) {
    threshold = new_thresh;
}

extern "C" JNIEXPORT jint JNICALL
Java_org_woheller69_weather_CacheScan_getthreshold(JNIEnv *env, jobject thiz) {
    return threshold;
}

/*
extern "C" JNIEXPORT void JNICALL
Java_org_woheller69_weather_CacheScan_filteraddr(JNIEnv *env, jobject thiz, jint index){
    pthread_mutex_lock(&g_lock);
    addr[index] = 0;
    pthread_mutex_unlock(&g_lock);
}
